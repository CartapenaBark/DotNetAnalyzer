...
> **Tip**: You can also install via the Claude Code Plugin for one-click setup. See [DotNetAnalyzer Plugin](https://github.com/CartapenaBark/DotNetAnalyzer/tree/develop/plugin).
