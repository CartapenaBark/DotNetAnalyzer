...
```csharp
// ✅ 正确：解释为什么
// Note: Using AssemblyInformationalVersion instead of AssemblyVersion,
// because InformationalVersion includes the Git commit hash for build tracking
private static string GetVersion()
{
    // ...
}
...
// ✅ 正确：公共 API 使用 XML 文档
/// <summary>
/// Gets detailed information about a .NET project, including source file list and dependencies.
/// </summary>
...
5. **[The Pragmatic Programmer](https://www.amazon.com/Pragmatic-Programmer-journey-mastery-020161622X)** - Andrew Hunt & David Thomas
